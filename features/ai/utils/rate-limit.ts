...
const limiters: Record<Provider, Ratelimit> = {
...
/** Checks (and consumes) one unit of the given user's daily quota for a provider. */
 ...
 */
export async function getRateLimitStatus(userId: string): Promise<UsageStatus[]> {
